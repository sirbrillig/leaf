module Leaf
  class Level < Chingu::GameState
    ...
    def edit
      push_game_state(LevelEditor.new(:grid => @grid, :file => @file, :snap_to_grid => false, :except => [Background, BackgroundObject, Player, Creature, Enemy, DetectionArea, VisibleArea]))
    end
